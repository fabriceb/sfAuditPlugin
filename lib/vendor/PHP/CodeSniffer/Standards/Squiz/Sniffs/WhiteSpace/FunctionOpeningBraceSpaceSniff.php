...
class Squiz_Sniffs_WhiteSpace_FunctionOpeningBraceSpaceSniff implements PHP_CodeSniffer_Sniff
{
  ...
  public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
  {
    ...
    if ($found > 0)
    {
      $nextReturn = $phpcsFile->findNext(T_RETURN, ($openBrace + 1), ($openBrace + 5));
      if ($nextReturn && $tokens[$nextReturn]['line'] === $braceLine + 2)
      {
        // OK the white line is justified, it precedes a return
      }
      else
      {
